<%@ Page Title="Edit Role" Language="C#" MasterPageFile="~/EClaims.master" AutoEventWireup="true" CodeBehind="EditRole.aspx.cs" Inherits="JustLoginWebsiteBoilerplate.Pages.EditRole" %>
                            ...
                            <div class="col-lg-8 col-lg-offset-2">
                                ...
                                <div class="row">
                                    <div class="col-xs-12" style="margin-bottom: 10px">
                                        <asp:ValidationSummary ID="ValidationSummary1" runat="server" DisplayMode="BulletList" ValidationGroup="UpdateRole" />
                                    </div>
                                </div>
                                ...
                                <table class="table table-striped eclaim-role">
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxRoleName" CssClass="form-control input-sm" placeholder="Enter name here" runat="server" ReadOnly="True"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" SetFocusOnError="True" ControlToValidate="TextBoxRoleName"
                                                                        ErrorMessage="Role Name cannot be empty." Display="None" ValidationGroup="UpdateRole">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <asp:TextBox ID="TextBoxDescription" CssClass="form-control input-sm" placeholder="Enter description" runat="server" ReadOnly="True" TextMode="MultiLine"></asp:TextBox>
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" SetFocusOnError="True" ControlToValidate="TextBoxDescription"
                                                                        ErrorMessage="Role Description cannot be empty." Display="None" ValidationGroup="UpdateRole">
                                            </asp:RequiredFieldValidator>
                                        </td>
                                    </tr>
                                ...
                                <asp:GridView ID="ExpenseReportGridView" runat="server" CssClass="table table-responsive table-striped eclaim-role"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField>
                                            <ItemTemplate>
                                                <asp:CheckBox ID="cbCheck" Enabled="<%# !ViewRole %>" Checked="<%# Item.Enabled %>" runat="server" data-id="<%#: Item.Id %>" data-code="<%#: Item.EnumName %>"></asp:CheckBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
                                ...
                                <%--<asp:GridView ID="AdvancePaymentGridView" runat="server" CssClass="table table-responsive table-striped eclaim-role"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:CheckBox ID="cbCheck" Enabled="<%# !ViewRole %>" Checked="<%# Item.Enabled %>" runat="server" onclick="Check_Click(this)" data-id="<%#: Item.Id %>" data-code="<%#: Item.EnumName %>"></asp:CheckBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>--%>
                                ...
                                <hr>
                                <div>
                                    <asp:Button ID="btnUpdateRole" CssClass="btn btn-success" runat="server" Text="Save" OnClick="UpdateRole_OnClick"
                                                OnClientClick="return SaveRole(this);" ValidationGroup="UpdateRole"/>
                                    &nbsp;
